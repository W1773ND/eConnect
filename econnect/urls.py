...
from econnect.views import Admin, HomeView, Numerilink, NumerilinkHotel, Homelink, Officelink, Corporatelink, \
    ...
    ChangeFaq, ChangeAdvertisement, AdvertisementList
...
urlpatterns = patterns(
    ...
    url(r'^STAFF/home/$', permission_required('econnect.ik_econnect_admin')(Admin.as_view()), name='admin'),
    ...
    url(r'^advertisements/$', permission_required('econnect.ik_econnect_admin')(AdvertisementList.as_view()), name='advertisement_list'),
    url(r'^advertisement/$', permission_required('econnect.ik_econnect_admin')(ChangeAdvertisement.as_view()), name='change_advertisement'),
    url(r'^advertisement/(?P<object_id>[-\w]+)/$', permission_required('econnect.ik_econnect_admin')(ChangeAdvertisement.as_view()), name='change_advertisement'),
    url(r'^STAFF/pendingOrder$', permission_required('econnect.ik_econnect_admin')(PendingOrderList.as_view()), name='pending_order'),
    url(r'^STAFF/paidOrder$', permission_required('econnect.ik_econnect_admin')(PaidOrderList.as_view()), name='paid_order'),
    url(r'^STAFF/reportedOrder$', permission_required('econnect.ik_econnect_admin')(ReportedOrderList.as_view()), name='reported_order'),
    url(r'^STAFF/canceledOrder$', permission_required('econnect.ik_econnect_admin')(CanceledOrderList.as_view()), name='canceled_order'),
