...
urlpatterns = patterns(
    ...
    url(r'^STAFF/home/$', permission_required('econnect.ik_admin')(Admin.as_view()), name='admin'),
    url(r'^STAFF/dashboard/$', permission_required('econnect.ik_view_dashboard')(Dashboard.as_view()), name='dashboard'),
    url(r'^products/$', permission_required('econnect.ik_admin')(ProductList.as_view()), name='product_list'),
    url(r'^product/$', permission_required('econnect.ik_webmaster')(ChangeProduct.as_view()), name='change_product'),
    url(r'^product/(?P<object_id>[-\w]+)/$', permission_required('econnect.ik_webmaster')(ChangeProduct.as_view()), name='change_product'),
    url(r'^packages/$', permission_required('econnect.ik_admin')(PackageList.as_view()), name='package_list'),
    url(r'^package/$', permission_required('econnect.ik_webmaster')(ChangePackage.as_view()), name='change_package'),
    url(r'^package/(?P<object_id>[-\w]+)/$', permission_required('econnect.ik_webmaster')(ChangePackage.as_view()), name='change_package'),
    url(r'^equipments/$', permission_required('econnect.ik_admin')(EquipmentList.as_view()), name='equipment_list'),
    url(r'^equipment/$', permission_required('econnect.ik_webmaster')(ChangeEquipment.as_view()), name='change_equipment'),
    url(r'^equipment/(?P<object_id>[-\w]+)/$', permission_required('econnect.ik_webmaster')(ChangeEquipment.as_view()), name='change_equipment'),
    url(r'^extras/$', permission_required('econnect.ik_admin')(ExtraList.as_view()), name='extra_list'),
    url(r'^extra/$', permission_required('econnect.ik_webmaster')(ChangeExtra.as_view()), name='change_extra'),
    url(r'^extra/(?P<object_id>[-\w]+)/$', permission_required('econnect.ik_webmaster')(ChangeExtra.as_view()), name='change_extra'),
    url(r'^faqs/$', permission_required('econnect.ik_admin')(FaqList.as_view()), name='faq_list'),
    url(r'^faq/$', permission_required('econnect.ik_sav')(ChangeFaq.as_view()), name='change_faq'),
    url(r'^faq/(?P<object_id>[-\w]+)/$', permission_required('econnect.ik_sav')(ChangeFaq.as_view()), name='change_faq'),
    url(r'^advertisements/$', permission_required('econnect.ik_admin')(AdvertisementList.as_view()), name='advertisement_list'),
    url(r'^advertisement/$', permission_required('econnect.ik_webmaster')(ChangeAdvertisement.as_view()), name='change_advertisement'),
    url(r'^advertisement/(?P<object_id>[-\w]+)/$', permission_required('econnect.ik_webmaster')(ChangeAdvertisement.as_view()), name='change_advertisement'),
    ...
    url(r'^mailCampaign/$', permission_required('echo.ik_sav')(ChangeMailCampaign.as_view()), name='change_mailcampaign'),
    url(r'^mailCampaign/(?P<object_id>[-\w]+)/$', permission_required('echo.ik_sav')(ChangeMailCampaign.as_view()), name='change_mailcampaign'),
